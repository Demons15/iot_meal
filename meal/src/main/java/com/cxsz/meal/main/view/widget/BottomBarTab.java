...
public class BottomBarTab extends FrameLayout {
    ...
    private void init(Context context, int icon, CharSequence title) {
        ...
        mIcon.setColorFilter(ContextCompat.getColor(context, R.color.color_ACACAC));
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.color_212121));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.color_212121));
        } else {
            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.color_ACACAC));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.color_ACACAC));
        }
    }

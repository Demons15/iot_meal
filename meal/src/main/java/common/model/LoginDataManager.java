...
public class LoginDataManager {
    ...
    private LoginManager mDataManager;

    public LoginDataManager(LoginManager mDataManager) {
    ...
    protected Disposable changeIOToMainThread(Observable<CodeData> observable, DisposableObserver<CodeData> consumer) {
